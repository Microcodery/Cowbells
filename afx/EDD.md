...
5. **Cluster**: viewpoints are ranked by arc width then view distance; one within 50 m of a kept viewpoint whose arcs are ≥80 % covered by the kept one is dropped.
